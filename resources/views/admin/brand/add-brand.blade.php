...
<div class="">
    <div class="col-md-10 offset-md-2">
        ...
        <div class="card text-center mt-5" style="width: 40rem;">
            <h5 class="card-header font-weight-bold text-primary">Add Brand Form</h5>
            <div class="card-body">                    
                <form action="{{route('new-brand')}}" method="POST" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                          <textarea name="brand_description" id="editor1" cols="30" rows="5" class="form-control"></textarea>
