        ...
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <textarea name="long_description" id="editor1"  class="form-control"></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" id="published" type="radio" name="publication_status" value="1">
