    ...
    <div class="">
        <div class="col-md-10 offset-md-2">
            ...
            <div class="card text-center mt-5" style="width: 40rem;">
              <h5 class="card-header font-weight-bold text-primary">Edit Category Form</h5>
                <div class="card-body">                    
                    <form action="{{route('update-category')}}" method="POST" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                              <textarea name="category_description" cols="30" rows="5" id="editor1" class="form-control">{{$category->category_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
