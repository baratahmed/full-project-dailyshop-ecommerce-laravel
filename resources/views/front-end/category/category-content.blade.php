             ...
             <div class="aa-product-catg-body">
               <ul class="aa-product-catg">
                @foreach($categoryProducts as $categoryProduct)
                 ...
                 <li>
                   <figure>
                     <a class="aa-product-img" href=""><img width="250" height="300" src="{{asset($categoryProduct->product_image)}}" alt="{{$categoryProduct->product_name}}"></a>
                     <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                     <figcaption>
                       <h4 class="aa-product-title"><a href="#">{{$categoryProduct->product_name}}</a></h4>
                       <span class="aa-product-price">Tk .{{$categoryProduct->product_price}}</span><span class="aa-product-price"></span>
           ...
           <aside class="aa-sidebar">
             ...
             <div class="aa-sidebar-widget">
               ...
               <div class="aa-recently-views">
                 <ul>
                   <li>
                     <a href="#" class="aa-cartbox-img"><img alt="img" src="{{asset('front-end')}}/img/woman-small-2.jpg"></a>
                   ...
                   <li>
                     <a href="#" class="aa-cartbox-img"><img alt="img" src="{{asset('front-end')}}/img/woman-small-1.jpg"></a>
                     <div class="aa-cartbox-info">
                       <h4><a href="#">Product Name</a></h4>
                       <p>1 x $250</p>
                     </div>                    
