             ...
             <div class="row">
               <div class="col-md-6">
                 <div class="aa-myaccount-register">                 
                  ...
                  <form action="{{route('customer-sign-up')}}" method="post" class="aa-login-form">
                    ...
                    <div class="form-group">
                        <input type="submit" name="cus_res_one" class="aa-browse-btn btn-block" id="resBtn" value="Register">
                    </div>                  
                  </form>
                 </div>
               </div>
               ...
               <div class="col-md-6">
                ...
                <form action="{{route('customer-login')}}" method="post" class="aa-login-form">
                    ...
                    <div class="form-group">
                        <input type="submit" name="cus_login_one" class=" aa-browse-btn btn-block" value="Log-in">
                    </div>
                    <div class="form-group">
