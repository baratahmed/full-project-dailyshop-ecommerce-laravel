...
Route::get('/',[
    'uses' => 'DailyShopController@index',
    'as'   => '/'
]);

Route::get('/category-product/{id}',[
    'uses' => 'DailyShopController@categoryProduct',
    'as'   => 'category-product'
]);

Route::get('/product-details/{id}/{name}',[
    'uses' => 'DailyShopController@productDetails',
    'as'   => 'product-details'
]);
...
Route::group(['middleware' => ['DailyShop']], function () {
...
Route::post('/checkout/new-customer-login-check', [
